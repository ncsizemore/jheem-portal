...
| Ratio framing | Should the primary ratio be gross downstream care cost per $1 of ADAP spending avoided, net cost divided by ADAP spending, or both? | The application leads with gross care cost per $1 cut and identifies the paper's net-cost ratio alongside it. Gross ratio equals net ratio plus one. | The two ratios answer related but different questions and should not share a label. |
